...
(defrule preproceso-datos::comprobar "Combrobar que información extraida sea correcta"
    ...
    (printout t "caracteristicas vivienda" crlf)
    (progn$ (?var $?caracteristicas-vivienda)
        (format t "%s" ?var)
        (printout t crlf)
    )
    (printout t "caracteristicas ciudad" crlf)
    (progn$ (?var $?caracteristicas-ciudad)
        (format t "%s" ?var)
        (printout t crlf)
    )
